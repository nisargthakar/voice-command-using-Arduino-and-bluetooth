...
//-----------------------------------------------------------------------//   
  ...
  else if(voice == "*system on") {digitalWrite(led4, HIGH);}
  ...
  else if(voice == "*system off") {digitalWrite(led4, LOW);}
  else if(voice == "*lights off") {digitalWrite(led5, LOW);}
//-----------------------------------------------------------------------// 
